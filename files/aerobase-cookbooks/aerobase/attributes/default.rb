...
default['unifiedpush']['aerobase-server']['ssl_certificate'] = "#{node['package']['runtime-dir']}/aerobase-server/tls.crt"
default['unifiedpush']['aerobase-server']['ssl_certificate_key'] = "#{node['package']['runtime-dir']}/aerobase-server/tls.key"
...
default['unifiedpush']['keycloak-server']['aerobase_patch'] = false
...
default['unifiedpush']['nginx']['sticky_cookie'] = nil # 'auth_session_id' 
