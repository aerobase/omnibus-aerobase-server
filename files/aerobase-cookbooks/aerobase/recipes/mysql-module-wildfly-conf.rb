...
remote_file "Copy mysql driver file" do
  path "#{modules_dir}/mysql-connector-java-8.0.17.jar"
  source "file:#{file_seperator}#{install_dir}/embedded/apps/mysql/mysql-connector-java-8.0.17.jar"
  owner aerobase_user
  group aerobase_group
  mode 0755
end
