...
set PATH=C:\Program Files (x86)\WiX Toolset v3.11\bin;C:\Program Files (x86)\Windows Kits\10\bin\x64;C:\Ruby27-x64\msys64\usr\bin;C:\Ruby27-x64\msys64\mingw64\bin;C:\Ruby27-x64\bin;%PATH%
set MSYSTEM=MINGW64
