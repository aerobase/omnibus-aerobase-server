...
name "unifiedpush-package-scripts"
...
build do
  ...
  Dir.glob(File.join(Omnibus::Config.project_root, 'config/templates/unifiedpush-package-scripts/*.erb')).each do |package_script|
